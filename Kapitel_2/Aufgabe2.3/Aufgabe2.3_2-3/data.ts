namespace Aufg2u3 {
    ...
    let flaschenkopf1: Bilder = { quelle: "assets/top1.png", art: 0, gravour: "exquisit", farbe: "silber"};
    let flaschenkopf2: Bilder = { quelle: "assets/top2.png", art: 0, gravour: "keine", farbe: "farblos"};
    let flaschenkopf3: Bilder = { quelle: "assets/top3.png", art: 0, gravour: "keine", farbe: "grün"};
